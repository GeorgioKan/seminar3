...
## Тут я конечно мог бы написать все необходимые команды, чтобы продемонстрировать вариант с Accept Current Change , но зачем же я тогда создавал такую вереницу веток?
